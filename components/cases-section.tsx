              ...
              >
                <Dialog>
                  <DialogTrigger asChild>
                    <Card 
                      className="group overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-2 cursor-pointer h-full flex flex-col"
                    ...
                    >
                      ...
                      <CardContent className="p-6 flex-1 flex flex-col">
                        <h3 className="text-xl font-semibold mb-2 text-balance leading-tight h-14 flex items-center">
                          <span className="line-clamp-2">{case_.title}</span>
                        </h3>
                        ...
                        <p className="text-muted-foreground text-sm text-pretty leading-relaxed mb-4 flex-1">
                          {case_.description}
                        </p>
